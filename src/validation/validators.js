...
export const maxDate = param => withParams(
...
export const requiredIfAnd = (param, rootModel) => withParams(
  ...
  (value, vm) => {
    const isRequired = Object.entries(param).every(([validatorName, validatorParam]) => {
      const validator = validators[validatorName];
      return (validator && validator(validatorParam, rootModel)(value, vm));
    });
    return isRequired ? requiredValidator(value) : true;
  },
);
